...
Please look at EventSubscriberTests for more clear understanding.
                       ...
                       DESC
  s.homepage = 'https://github.com/dlpigpen/EventSubscriber-Pod'
  s.license = { :type => 'MIT', :file => 'LICENSE' }
  s.author = { 'uTiko' => 'tiko@utiko.net' }
  s.source = { :git => 'https://github.com/dlpigpen/EventSubscriber-Pod.git', :tag => '0.2' }
